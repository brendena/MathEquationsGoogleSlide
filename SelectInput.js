...
var _user$project$Main$logoIconSrc = 'https://github.com/brendena/MathEquationsGoogleSlide/blob/master/image/logoNoBackground64by64.png?raw=true';
...
var _user$project$Main$infoFooter = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Code at '),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('https://github.com/brendena/MathEquationsGoogleSlide'),
							_1: {
								ctor: '::',
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Github Repo / For Bug Reports'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('mailto:bafeaturerequest@gmail.com?Subject=Bug%20or%20Feature'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Message me'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(' at bafeaturerequest@gmail.com'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Main$helpPageStyles = function (bool) {
	return _elm_lang$core$Native_Utils.eq(bool, true) ? _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'transform', _1: 'translateX(100%)'},
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$viewOption = function (mathType) {
	return A2(
		_elm_lang$html$Html$option,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$value(
				_elm_lang$core$Basics$toString(mathType)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$toOptionString = function (currency) {
	var _p0 = currency;
	switch (_p0.ctor) {
		case 'MathML':
			return 'MathML';
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				...
				_1: _elm_lang$core$Json_Encode$string(
					_user$project$Main$toOptionString(model.mathType))
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'linkedMathEquation',
					_1: _elm_lang$core$Json_Encode$string(model.linkedMathEquation)
				},
				_1: {
					ctor: '::',
					_0: {
					...
					_1: {
						...
						_1: {
							...
							_0: {
								...
								_0: 'mathEquationSize',
								_1: _elm_lang$core$Json_Encode$string(
									_elm_lang$core$Basics$toString(model.sizeEquation))
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Main$equationSizeLarge = 50;
var _user$project$Main$equationSizeMedium = 25;
var _user$project$Main$equationSizeSmall = 12;
var _user$project$Main$reloadEquaion = _elm_lang$core$Native_Platform.outgoingPort(
	'reloadEquaion',
	function (v) {
		return v;
	});
var _user$project$Main$updateEquaion = _elm_lang$core$Native_Platform.outgoingPort(
	'updateEquaion',
	function (v) {
		return v;
	});
...
var _user$project$Main$updatingLinkedMathEquation = _elm_lang$core$Native_Platform.incomingPort('updatingLinkedMathEquation', _elm_lang$core$Json_Decode$string);
var _user$project$Main$updatingMathEquationColor = _elm_lang$core$Native_Platform.incomingPort('updatingMathEquationColor', _elm_lang$core$Json_Decode$string);
var _user$project$Main$updatingMathEquation = _elm_lang$core$Native_Platform.incomingPort('updatingMathEquation', _elm_lang$core$Json_Decode$string);
var _user$project$Main$updateErrorMessage = _elm_lang$core$Native_Platform.incomingPort('updateErrorMessage', _elm_lang$core$Json_Decode$string);
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {mathType: a, linkedMathEquation: b, mathEquation: c, errorMessage: d, mathEquationColor: e, helpPageOpen: f, sizeEquation: g};
	});
var _user$project$Main$Tex = {ctor: 'Tex'};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A7(_user$project$Main$Model, _user$project$Main$Tex, '', '', '', '#000000', false, _user$project$Main$equationSizeMedium),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$AsciiMath = {ctor: 'AsciiMath'};
var _user$project$Main$MathML = {ctor: 'MathML'};
var _user$project$Main$valuesWithLabels = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: _user$project$Main$MathML, _1: 'MathML'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: _user$project$Main$AsciiMath, _1: 'AsciiMath'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _user$project$Main$Tex, _1: 'Tex'},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Main$fromOptionString = function (string) {
	var _p1 = string;
	switch (_p1) {
		case 'MathML':
			return _user$project$Main$MathML;
		case 'AsciiMath':
			return _user$project$Main$AsciiMath;
		case 'Tex':
			return _user$project$Main$Tex;
		default:
			return _user$project$Main$Tex;
	}
};
		...
		switch (_p2.ctor) {
			case 'MathTypeChange':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						mathType: _user$project$Main$fromOptionString(_p2._0)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
					_1: _user$project$Main$updateEquaion(
						A2(
			...
			case 'ReloadEquaion':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$reloadEquaion('reload')
				};
			case 'SumitEquation':
				return {
					ctor: '_Tuple2',
			...
			case 'SetLinkedMathEquation':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{linkedMathEquation: _p2._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleHelpPage':
				return {
			...
			case 'UpdateMathEquation':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{mathEquationColor: _p2._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateSizeEquation':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				...
				var removeBadNum = function (sizeIntTmp) {
					return (_elm_lang$core$Native_Utils.cmp(sizeInt, 1) < 0) ? 1 : sizeIntTmp;
				};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							sizeEquation: removeBadNum(sizeInt)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$UpdateInputSizeEquation = function (a) {
	return {ctor: 'UpdateInputSizeEquation', _0: a};
};
var _user$project$Main$UpdateSizeEquation = function (a) {
	return {ctor: 'UpdateSizeEquation', _0: a};
};
var _user$project$Main$UpdateMathEquation = function (a) {
	return {ctor: 'UpdateMathEquation', _0: a};
};
var _user$project$Main$UpdateErrorMessage = function (a) {
	return {ctor: 'UpdateErrorMessage', _0: a};
};
var _user$project$Main$ToggleHelpPage = function (a) {
	return {ctor: 'ToggleHelpPage', _0: a};
};
var _user$project$Main$helpPage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('helpPage'),
			_1: {
				ctor: '::',
				_0: _user$project$Main$helpPageStyles(model.helpPageOpen),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Help Page'),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('exitIcon'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Main$ToggleHelpPage(false)),
									_1: {ctor: '[]'}
								}
							},
							{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Create an Equation'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$img,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(_user$project$Main$logoIconSrc),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
						...
						_0: A2(
							_elm_lang$html$Html$p,
							{
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'indentText', _1: true},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										...
										A2(_elm_lang$core$Basics_ops['++'], 'text box.  Right underneath the text box will be a example of the output.  Once you are done hit the submit button and it will create a image of the ', 'equation'))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Updating Equation'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											A2(_elm_lang$core$Basics_ops['++'], 'To update an image select the image you want and hit the reload icon.  This will bind the image to the extension and whenever you hit the', ' button it will update the image.  To stop updating a image hit the unconnect button.')),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
														...
														_1: {
															...
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('The \'copy to clipboard\' button takes the equation\'s image and loads it into the current slide.'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('If the equation is connected you should see the \'Unconnected equation\' button.  This disconnecteds the current equation and will allow you to create a new image. '),
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		}
...
var _user$project$Main$infoHeader = A2(
	...
	{ctor: '[]'},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('</Equations>'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('helpIcon'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$ToggleHelpPage(true)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(_user$project$Main$iconHelp),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _user$project$Main$UpdateEquaion = function (a) {
	return {ctor: 'UpdateEquaion', _0: a};
};
var _user$project$Main$SetLinkedMathEquation = function (a) {
	return {ctor: 'SetLinkedMathEquation', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$updatingLinkedMathEquation(_user$project$Main$SetLinkedMathEquation),
			_1: {
				ctor: '::',
				_0: _user$project$Main$updatingMathEquation(_user$project$Main$UpdateEquaion),
				_1: {
					ctor: '::',
					_0: _user$project$Main$updateErrorMessage(_user$project$Main$UpdateErrorMessage),
					_1: {
						ctor: '::',
						_0: _user$project$Main$updatingMathEquationColor(_user$project$Main$UpdateMathEquation),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$SumitEquation = {ctor: 'SumitEquation'};
var _user$project$Main$ReloadEquaion = {ctor: 'ReloadEquaion'};
var _user$project$Main$MathTypeChange = function (a) {
	return {ctor: 'MathTypeChange', _0: a};
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('elmContainer'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Main$infoHeader,
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('siteMainContent'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$MathTypeChange),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('selectMathType'),
									_1: {ctor: '[]'}
								}
							},
							{
								ctor: '::',
								_0: _user$project$Main$viewOption(_user$project$Main$Tex),
								_1: {
									ctor: '::',
									_0: _user$project$Main$viewOption(_user$project$Main$MathML),
									_1: {
										ctor: '::',
										_0: _user$project$Main$viewOption(_user$project$Main$AsciiMath),
										_1: {ctor: '[]'}
									}
								}
							}),
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('sizeSelectContainer'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Main$UpdateSizeEquation(_user$project$Main$equationSizeSmall)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$classList(
														{
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'iconSizeButton', _1: true},
															_1: {
																ctor: '::',
																_0: {
																	ctor: '_Tuple2',
																	_0: 'iconSizeButtonSelected',
																	_1: _elm_lang$core$Native_Utils.eq(model.sizeEquation, _user$project$Main$equationSizeSmall)
																},
																_1: {ctor: '[]'}
															}
														}),
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Main$UpdateSizeEquation(_user$project$Main$equationSizeMedium)),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$classList(
															{
																...
																_1: {
																	...
																	_0: {
																		ctor: '_Tuple2',
																		_0: 'iconSizeButtonSelected',
																		_1: _elm_lang$core$Native_Utils.eq(model.sizeEquation, _user$project$Main$equationSizeMedium)
																	},
																	_1: {ctor: '[]'}
																}
															}),
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$button,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Main$UpdateSizeEquation(_user$project$Main$equationSizeLarge)),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$classList(
																{
																	...
																	_1: {
																		...
																		_0: {
																			ctor: '_Tuple2',
																			_0: 'iconSizeButtonSelected',
																			_1: _elm_lang$core$Native_Utils.eq(model.sizeEquation, _user$project$Main$equationSizeLarge)
																		},
																		_1: {ctor: '[]'}
																	}
																}),
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$id('textInputSize'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateInputSizeEquation),
																_1: {
																	ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('textAreaMathEquation'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateEquaion),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.mathEquation),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder('Equation code placeholder'),
														_1: {ctor: '[]'}
													}
												}
											}
									...
									_1: {
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$id('submitMathEquation'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SumitEquation),
															_1: {ctor: '[]'}
														}
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('add to slide'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$id('reloadContainer'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ReloadEquaion),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Connect to Equation'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
															...
															_1: {
																...
																_0: A2(
																	_elm_lang$html$Html$button,
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onClick(
																			_user$project$Main$SetLinkedMathEquation('')),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$hidden(
																				_elm_lang$core$String$isEmpty(model.linkedMathEquation)),
																			_1: {ctor: '[]'}
																		}
																	},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Disconnect from Equation'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('SvgContainer'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$id('AsciiMathEquation'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$hidden(
																	!_elm_lang$core$Native_Utils.eq(_user$project$Main$AsciiMath, model.mathType)),
																_1: {ctor: '[]'}
															}
														},
														{
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$id('TexEquation'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$hidden(
																		!_elm_lang$core$Native_Utils.eq(_user$project$Main$Tex, model.mathType)),
																	_1: {ctor: '[]'}
																}
															},
															{
														...
														_1: {
															...
															_0: A2(
																_elm_lang$html$Html$div,
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$hidden(
																		!_elm_lang$core$Native_Utils.eq(_user$project$Main$MathML, model.mathType)),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	...
																	_1: {
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$id('MathMLEquation'),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$id('ErrorMessage'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$hidden(
																_elm_lang$core$String$isEmpty(model.errorMessage)),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	_user$project$Main$UpdateErrorMessage('')),
																_1: {ctor: '[]'}
															}
														}
													},
													{
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(
																	A2(_elm_lang$core$Basics_ops['++'], 'Error - ', model.errorMessage)),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}),
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$helpPage(model),
					_1: {
						ctor: '::',
